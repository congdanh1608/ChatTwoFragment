...
public class User1Fragment extends Fragment {
        ...
        btnSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!TextUtils.isEmpty(edtChat.getText())) {    //Check textview is empty?
                    strings.add(MainActivity.user1 + edtChat.getText().toString());
                    addText(MainActivity.user1 + edtChat.getText().toString());
                    edtChat.setText("");
                }
            }
        });
    ...
    //send content chat to user2
    public void sendText(ArrayList<String> text) {
        mCallback.sendTextTo2(text);
    }
